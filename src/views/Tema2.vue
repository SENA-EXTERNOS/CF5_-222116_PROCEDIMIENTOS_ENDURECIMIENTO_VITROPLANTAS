...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    #t_2_1.titulo-segundo.color-acento-contenido.mt-5
      h2 2.1.	Alistamiento de espacios de germinación
    p.mb-5 En el proceso de consolidación de espacios para el endurecimiento, se describe en este apartado el alistamiento de espacios de germinación.
        ...
        SlyderF(columnas="col-sm-4")
          ...
          .tarjeta.tarjeta.color-secundario.bg-tarjeta.h-slider.p-4
            .row.justify-content-center.mb-2
              ...
              p.mt-5.texto-centro El conocimiento de la especie a reproducir asexualmente puede requerir de la dosificación exacta en el uso de aquellas hormonas; las cuales deben estar, bien sea en el medio de cultivo, o bien sea en sustratos cuando se dispone a etapas más avanzadas. 
    ...
    #t_2_2.titulo-segundo.color-acento-contenido.mt-5
      h2 2.2.	Preparación y desinfección de sustratos para el endurecimiento
        ...
        .col-lg-10.position-relative         
          ...
          .crd.crd--avatarHorizontal.crd--first.py-4
            .row.align-items-center
              ...
              .col
                  h5 Físicas 
                  p Como su estructura, arcillosos o arenosos.
          ...
          .crd.crd--avatarHorizontal.py-4
            .row.align-items-center
              ...
              .col
                h5 Biológicas 
                p Como microorganismos presentes.
          ...
          .crd.crd--avatarHorizontal.crd--three.py-4
            .row.align-items-center
              ...
              .col
                h5 Químicas 
                p Representado por macroelementos y microelementos. 
                     


    p.mt-5  Se presentan en este apartado elementos indispensables a considerar en la preparación y desinfección de sustratos para el endurecimiento.
      ...
      .row.justify-content-center
        .col-lg-11
          ImagenInfograficaB.color-primario
            ...
            div(x="40%" y="44%" tooltip="Ver más" numero="+")
              .tarjeta.white-card.p-4
                .row
                  p.mb-3  El primero hace referencia al uso de productos de síntesis química que se adiciona para eliminar cualquier tipo de microorganismo vivo allí presente con un principio biocida.

            div(x="67%" y="75%" tooltip="Ver más" numero="+")
              .tarjeta.white-card.p-4
                .row
    ...
    #t_2_3.titulo-segundo.color-acento-contenido.mt-5
      h2 2.3.	Normatividad de seguridad industrial y seguridad en el trabajo
      ...
      .row.justify-content-center
        .col-lg-11
          ImagenInfograficaB.color-primario
            ...
            div(x="40%" y="51%" tooltip="Ver más" numero="+")
              .tarjeta.white-card.p-4
                .row
                  p.mb-3  La Resolución 2400 de 1979 (mayo 22) por el Ministerio de Trabajo y Seguridad Social, en donde especifica en el capítulo 2º, página 1, que se debe dar cumplimiento a normas legales en Medicina, Higiene y Seguridad Industrial, y dependiendo el contexto se elabora su propia reglamentación.
...
export default {
  ...
  data: () => ({
    datosSlyder: [
      ...
      {
        texto:
          'El caso del endurecimiento de vitroplantas implica el paso de un ambiente controlado en recipientes de vidrio a bandejas, en donde dichas variables cambian a pesar de seguir interfiriendo en su control; cuando se inicia la aclimatación se dispone de estructuras adecuadas para que en la germinación o regeneración de brotes se inicien el reconocimiento de las variaciones climáticas y empiecen las respuestas fisiológicas para tal fin.',
        imagen: require('@/assets/curso/temas/tema2/img2.png'),
      },
      {
        texto:
          'Al ser un espacio para obtener un número elevado de plántulas encaminadas a producción o conservación, entre otros fines, es importante tener la claridad para disponer de las técnicas de manejo adecuadas, pues los procedimientos dispendiosos al valorar cada uno de los ejemplares y los errores en los métodos de aplicación podrán impactar negativamente si todo el material vegetal se encuentra en la misma sección de crecimiento. ',
      ...
      {
        texto:
          'Atendiendo todos los posibles escenarios y las dinámicas cambiantes para una vitroplanta, para pasar de una fase a otra es importante reconocer que una de sus alteraciones, como la pérdida de humedad, es razón suficiente para asignar espacios adecuados especialmente. Así estas pueden lograr que estructuras como los estomas de las hojas de las plantas que no habían sido muy desarrollados durante la fase inicial, empiecen a actuar en el ejercicio del intercambio gaseoso. Es allí, en las cámaras de humedad o bajo la utilización de mallas de diferentes características y densidades, y bajo estos métodos, que se puede lograr presionar poco a poco la fisiología de la especie para responder ante dichas variaciones de las condiciones agroclimáticas.',
